...
public class TrackerInformation extends IdentifiedElement {
     ...
     */
    public TrackerInformation(ITrackerType type, String name, String version) {
        this.type = type;
        this.name = name;
     ...
     */
    public void setType(ITrackerType type) {
        this.type = type;
    }
