...
import net.frogmouth.rnd.jim.s4676.message.sensormeasurement.IMeasurementMethod;
import net.frogmouth.rnd.jim.s4676.message.sensormeasurement.IMeasurementType;
import net.frogmouth.rnd.jim.s4676.message.sensormeasurement.MeasurementMethodDeserialiser;
import net.frogmouth.rnd.jim.s4676.message.sensormeasurement.MeasurementTypeDeserialiser;
...
public class Parser {
    ...
    private void registerDeserialisers(XmlMapper mapper) {
        ...
        module.addDeserializer(IImageFormat.class, new ImageFormatDeserialiser());
        module.addDeserializer(IMeasurementMethod.class, new MeasurementMethodDeserialiser());
        module.addDeserializer(IMeasurementType.class, new MeasurementTypeDeserialiser());
