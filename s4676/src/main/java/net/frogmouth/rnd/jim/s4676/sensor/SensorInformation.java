...
public class SensorInformation extends IdentifiedElement {
    ...
    @JacksonXmlProperty(namespace = "urn:nato:niia:stanag:4676:isrtrackingstandard:b:1")
    private IModalityType modality;
     ...
     */
    public SensorInformation(String name, IModalityType modality) {
        this.name = name;
     ...
     * @return the modality
     */
    public IModalityType getModality() {
        return modality;
    }
     ...
     * @param modality the modality
     */
    public void setModality(IModalityType modality) {
        this.modality = modality;
    }
