...
import net.frogmouth.rnd.jim.s4676.enumeration.SupplementaryDataType;
...
public class SupplementaryData {
    ...
    private SupplementaryDataType type;
     ...
     */
    public SupplementaryData(SupplementaryDataType type, String name, String version) {
        this.type = type;
        this.name = name;
     ...
     * @return the type
     */
    public SupplementaryDataType getType() {
        return type;
    }
     ...
     * @param type the type
     */
    public void setType(SupplementaryDataType type) {
        this.type = type;
    }
